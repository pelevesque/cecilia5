...
# Meter icons
ICON_VUMETER = catalog['vu-metre2']
ICON_VUMETER_DARK = catalog['vu-metre-dark2']
# Plugin icons
ICON_PLUGINS_KNOB = catalog['knob-trans-sm']
ICON_PLUGINS_KNOB_DISABLE = catalog['knob-disab-sm']
ICON_PLUGINS_ARROW_UP = catalog['arrow_up']
ICON_PLUGINS_ARROW_UP_HOVER = catalog['arrow_up_hover']
ICON_PLUGINS_ARROW_DOWN = catalog['arrow_down']
ICON_PLUGINS_ARROW_DOWN_HOVER = catalog['arrow_down_hover']
# Toolbox icons
ICON_TB_LOAD = catalog['load-normal-trans']
ICON_TB_LOAD_OVER = catalog['load-hover-trans']
ICON_TB_SAVE = catalog['save-normal-trans']
ICON_TB_SAVE_OVER = catalog['save-hover-trans']
ICON_TB_RESET = catalog['reset-normal-trans']
ICON_TB_RESET_OVER = catalog['reset-hover-trans']
ICON_TB_SHOW = catalog['show-normal-trans']
ICON_TB_SHOW_OVER = catalog['show-hover-trans']
ICON_TB_HIDE = catalog['hide-normal-trans']
ICON_TB_HIDE_OVER = catalog['hide-hover-trans']
ICON_TB_RECYCLE = catalog['recycle-normal-trans']
ICON_TB_RECYCLE_OVER = catalog['recycle-hover-trans']
ICON_TB_PLAY = catalog['play-normal-trans']
ICON_TB_PLAY_OVER = catalog['play-hover-trans']
ICON_TB_EDIT = catalog['edit-normal-trans']
ICON_TB_EDIT_OVER = catalog['edit-hover-trans']
ICON_TB_OPEN = catalog['open-normal-trans']
ICON_TB_OPEN_OVER = catalog['open-hover-trans']
ICON_TB_CLOSE = catalog['close-normal-trans']
ICON_TB_CLOSE_OVER = catalog['close-hover-trans']
ICON_TB_TIME = catalog['time-normal-trans']
ICON_TB_TIME_OVER = catalog['time-hover-trans']
ICON_TB_DELETE = catalog['delete-normal-trans']
ICON_TB_DELETE_OVER = catalog['delete-hover-trans']
# RadioToolbox icons
ICON_RTB_POINTER = catalog['pointer-normal-trans']
ICON_RTB_POINTER_OVER = catalog['pointer-hover-trans']
ICON_RTB_POINTER_CLICK = catalog['pointer-click-trans']
ICON_RTB_PENCIL = catalog['pencil-normal-trans']
ICON_RTB_PENCIL_OVER = catalog['pencil-hover-trans']
ICON_RTB_PENCIL_CLICK = catalog['pencil-click-trans']
ICON_RTB_ZOOM = catalog['zoom-normal-trans']
ICON_RTB_ZOOM_OVER = catalog['zoom-hover-trans']
ICON_RTB_ZOOM_CLICK = catalog['zoom-click-trans']
ICON_RTB_HAND = catalog['hand-normal-trans']
ICON_RTB_HAND_OVER = catalog['hand-hover-trans']
ICON_RTB_HAND_CLICK = catalog['hand-click-trans']
# PrefRadioToolbox icons
ICON_PREF_AUDIO = catalog['audio-normal-trans']
ICON_PREF_AUDIO_OVER = catalog['audio-hover-trans']
ICON_PREF_AUDIO_CLICK = catalog['audio-click-trans']
ICON_PREF_CECILIA = catalog['cecilia-normal-trans']
ICON_PREF_CECILIA_OVER = catalog['cecilia-hover-trans']
ICON_PREF_CECILIA_CLICK = catalog['cecilia-click-trans']
ICON_PREF_FILER = catalog['filer-normal-trans']
ICON_PREF_FILER_OVER = catalog['filer-hover-trans']
ICON_PREF_FILER_CLICK = catalog['filer-click-trans']
ICON_PREF_PATH = catalog['path-normal-trans']
ICON_PREF_PATH_OVER = catalog['path-hover-trans']
ICON_PREF_PATH_CLICK = catalog['path-click-trans']
ICON_PREF_MIDI = catalog['midi-normal-trans']
ICON_PREF_MIDI_OVER = catalog['midi-hover-trans']
ICON_PREF_MIDI_CLICK = catalog['midi-click-trans']
# PaletteToolBox icons
ICON_PTB_PROCESS = catalog['process-normal-trans']
ICON_PTB_PROCESS_OVER = catalog['process-hover-trans']
ICON_PTB_RANDOM = catalog['random-normal-trans']
ICON_PTB_RANDOM_OVER = catalog['random-hover-trans']
ICON_PTB_WAVES = catalog['waves-normal-trans']
ICON_PTB_WAVES_OVER = catalog['waves-hover-trans']
# Input icons
ICON_INPUT_1_FILE = catalog['input-1-file']
ICON_INPUT_2_LIVE = catalog['input-2-live']
ICON_INPUT_3_MIC = catalog['input-3-mic']
ICON_INPUT_4_MIC_RECIRC = catalog['input-4-mic-recirc']
# Crossfade icons
ICON_XFADE_LINEAR = catalog['xfade-linear']
ICON_XFADE_POWER = catalog['xfade-power']
ICON_XFADE_SIGMOID = catalog['xfade-sigmoid']
# Mario bros
ICON_MARIO1 = catalog['Mario1']
ICON_MARIO2 = catalog['Mario2']
ICON_MARIO3 = catalog['Mario3']
ICON_MARIO4 = catalog['Mario4']
ICON_MARIO5 = catalog['Mario5']
ICON_MARIO6 = catalog['Mario6']
# Grapher background
ICON_GRAPHER_BACKGROUND = catalog['Grapher_background']
# About icon
ICON_CECILIA_ABOUT_SMALL = catalog['Cecilia_about_small']
# Doc frame icons
ICON_DOC_PREVIOUS = catalog['previous_24']
ICON_DOC_NEXT = catalog['next_24']
ICON_DOC_UP = catalog['up_24']
...
TR_CLOCKER_BACK_COLOUR = "#506077" #'#99A7CC'
PREFS_FOREGROUND = '#EEEEEE'
PREFS_PATH_BACKGROUND = '#AAAAAA'

# Hue, Brightness, Saturation
COLOUR_CLASSES = {  'grey': [0., 0.25, 0.],
                    'green': [100., 0.25, .75],
